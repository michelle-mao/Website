...
##### The syntax for indexing in Python is list[start:stop:step]. Let's try grabbing every other element from the first element through the eighth element. Notice that we can leave the "start" number blank because it defaults to 0. The step number defaults to 1.
